...
def run(n,heads,repeats):
 ...
 scale=128**-0.5
 variants={'compiled_control':64,'k128_cta3':71,'lookahead_cta1':81,'scratch_pipeline_cta2':84,'scratch_pipeline_cta3':85}
